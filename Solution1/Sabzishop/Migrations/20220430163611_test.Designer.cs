            ...
            modelBuilder.Entity("Sabzishop.Models.Discount.Descount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 30, 21, 6, 8, 791, DateTimeKind.Local).AddTicks(8685),
                            pricedes = 590000m,
                            proid = 4L
                        },
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 30, 21, 6, 8, 815, DateTimeKind.Local).AddTicks(7689),
                            pricedes = 490000m,
                            proid = 7L
                        },
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 30, 21, 6, 8, 815, DateTimeKind.Local).AddTicks(7735),
                            pricedes = 390000m,
                            proid = 8L
                        },
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 30, 21, 6, 8, 815, DateTimeKind.Local).AddTicks(7742),
                            pricedes = 490000m,
                            proid = 10L
                        },
                        new
                        {
                            id = 5L,
                            enddes = new DateTime(2022, 5, 2, 5, 10, 20, 0, DateTimeKind.Unspecified),
                            now = new DateTime(2022, 4, 30, 21, 6, 8, 815, DateTimeKind.Local).AddTicks(7747),
                            pricedes = 990000m,
                            proid = 11L
                        });
                });
