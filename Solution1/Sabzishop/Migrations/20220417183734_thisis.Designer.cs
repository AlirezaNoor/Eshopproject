...
namespace Sabzishop.Migrations
{
    ...
    [Migration("20220417183734_thisis")]
            ...
            modelBuilder.Entity("Sabzishop.Models.Discount.Descount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 17, 23, 7, 33, 80, DateTimeKind.Local).AddTicks(6533),
                            pricedes = 590000m,
                            proid = 4L
                        },
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 17, 23, 7, 33, 104, DateTimeKind.Local).AddTicks(4445),
                            pricedes = 490000m,
                            proid = 7L
                        },
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 17, 23, 7, 33, 104, DateTimeKind.Local).AddTicks(4490),
                            pricedes = 390000m,
                            proid = 8L
                        },
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 17, 23, 7, 33, 104, DateTimeKind.Local).AddTicks(4497),
                            pricedes = 490000m,
                            proid = 10L
                        },
                        new
                        {
                            id = 5L,
                            enddes = new DateTime(2022, 5, 2, 5, 10, 20, 0, DateTimeKind.Unspecified),
                            now = new DateTime(2022, 4, 17, 23, 7, 33, 104, DateTimeKind.Local).AddTicks(4501),
                            pricedes = 990000m,
                            proid = 11L
                        });
                });
