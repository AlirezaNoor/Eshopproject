...
namespace Sabzishop.Migrations
{
    ...
    [Migration("20220425140125_thisisadd")]
    partial class thisisadd
    {
            ...
            modelBuilder.Entity("Sabzishop.Models.Discount.Descount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 25, 18, 31, 24, 664, DateTimeKind.Local).AddTicks(8171),
                            pricedes = 590000m,
                            proid = 4L
                        },
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 25, 18, 31, 24, 679, DateTimeKind.Local).AddTicks(4242),
                            pricedes = 490000m,
                            proid = 7L
                        },
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 25, 18, 31, 24, 679, DateTimeKind.Local).AddTicks(4296),
                            pricedes = 390000m,
                            proid = 8L
                        },
                        new
                        {
                            ...
                            now = new DateTime(2022, 4, 25, 18, 31, 24, 679, DateTimeKind.Local).AddTicks(4303),
                            pricedes = 490000m,
                            proid = 10L
                        },
                        new
                        {
                            id = 5L,
                            enddes = new DateTime(2022, 5, 2, 5, 10, 20, 0, DateTimeKind.Unspecified),
                            now = new DateTime(2022, 4, 25, 18, 31, 24, 679, DateTimeKind.Local).AddTicks(4307),
                            pricedes = 990000m,
                            proid = 11L
                        });
                });
